...
class Xception(nn.Module):
	...
	def __init__(self, in_channel=26, num_classes=17):
		""" Constructor
		Args:
		...
		self.conv1 = nn.Conv2d(in_channel, 32, 3, 1, 1, bias=False)
		...
		self.block2 = Block(128, 256, 2, 1, start_with_relu=True, grow_first=True)
		...
		self.conv3 = SeparableConv2d(1024, 1024, 3, 1, 1)
		self.bn3 = nn.BatchNorm2d(1024)

		# do relu here
		self.conv4 = SeparableConv2d(1024, 1024, 3, 1, 1)
